<template>
	<view class="container">
		...
		<view class="user-section">
			<image class="bg" src="/static/img/txbj.png"></image>
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="userinfo.headIcon || '/static/img/bmfw.png'"></image>
				</view>
				<view class="info-box">
	...
	export default {
		...
		onShow() {
			...
			if(userinfo.headIcon){
				this.userinfo.headIcon = this.$baseUrl +  "serviceitem/getImg?data=" + this.userinfo.headIcon + "&loginMark=" + logininfo.loginMark + "&token=" + logininfo.token;
			}
